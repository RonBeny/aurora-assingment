...
curl \
  ...
  https://api.github.com/repos/RonBeny/Aurora/hooks \
  -d "{\"name\":\"web\",\"active\":true,\"events\":[\"push\",\"pull_request\"],\"config\":{\"url\":\"$url/github-webhook/\",\"content_type\":\"json\",\"insecure_ssl\":\"0\"}}"